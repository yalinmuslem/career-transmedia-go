    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card rounded-4">
                <div class="card-body">
                    <h1 class="fs-2 fw-bold mb-10">Description</h1>
                    <h1 class="fs-2 fw-bold mb-10">Job Responsibilities</h1>
                    <div class="card rounded-4 text-bg-primary">
                        <div class="card-body p-5">
                            <h1 class="fs-2 fw-bold text-white">Requirements</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <?php foreach ($others as $value) : ?>
                        <div class="mb-3">
                            <div class="fs-4 mb-2 text-uppercase">
                                <a href="<?= base_url(index_page() . '/requirement/' . $value['id']) ?>"><?= $value['jabatan'] ?></a>
                            </div>
